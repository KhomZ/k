	...
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<p style = "position:relative; float:left; width:850px;">Hotel Lakeside, Pokhara a celebrated balance of nostalgia and contemporary style, capturing its original Southern elegance, luxury, and decadence. Hotel Lakeside floors contrast modern furnishings and amenities in the dramatic suites.
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Small Size Bed</label> <label style = "color:red;">NRs. 2,000.00</label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label style = "color:red;">NRs. 800.00</label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>1 Medium Size Bed</label> <label style = "color:red;">NRs. 2,400.00 </label></center>
				</div>
				<br style = "clear:both;"/>
				<br />
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>2 Medium Size Bed</label> <label style = "color:red;">NRs. 2,800.00 </label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Matrimonial</label> <label style = "color:red;">NRs. 3,800.00 </label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Matrimonial</label> <label style = "color:red;">NRs. 4,000.00 </label></center>
				</div>
				<br style = "clear:both;"/>
				<br />
				<br />
